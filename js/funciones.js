...
var arrDivs = ['divMainIngresos', 'divMainGastos', 'divMainCatalogos', 'divMainReportes', 'divMainDashboard'];
...
function obtieneNombreArchivo(){
  var archivo = document.getElementById("txtArchivos");
  var img = document.getElementById("img01");
  alert(archivo.value);
  img.href=archivo.value;
}
